...
missing link between processes and user-land containers. Please also refer to
the description of the [Information Model in the lxkns online manual] for
further information and UML diagrams besides this API documentation.
...
Namespaces have unique identifiers, yet these are not names, but inode numbers
...
namespace of each type. However, earlier kernels lack time namespace support, so
...
[Information Model in the lxkns online manual]: https://thediveo.github.io/lxkns/#/model
*/
package model
