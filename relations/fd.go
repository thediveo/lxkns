...
// ID returns the namespace ID in form of its inode number for any given Linux
// kernel namespace reference. Please be aware that ID even returns an inode
// number if the file descriptor doesn't reference a namespace but instead some
// other open file.
