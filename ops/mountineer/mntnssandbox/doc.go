...
[thediveo/gons]. Our variant here only supports switching the mount namespace
and optionally the user namespace, and then immediately goes into endless sleep.
...
(CAP_SYS_ADMIN and CAP_SYS_CHROOT in case of mount namespaces, see also
[capabilities(7)] for details).

[thediveo/gons]: https://github.com/thediveo/gons
